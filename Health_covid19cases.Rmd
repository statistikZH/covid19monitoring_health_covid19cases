...
cases_sel <- cases %>%
  ...
  mutate(
      ...
      variable_short == "sarscov2_verstorbene" ~  "Gemeldete Anzahl von bestätigten SARS-CoV-2 Verstorbene ",
      TRUE ~ "???"),
    topic = "Gesundheit",
    location = "ZH",
    unit= "Anzahl",
...
write.table(cases_sel, "./Health_covid19cases.csv", sep=",", fileEncoding="UTF-8", row.names = F)
